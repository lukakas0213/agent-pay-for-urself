...
* 백엔드는 `agent_pay_for_urself` 패키지 로거에 콘솔 핸들러를 붙여, CLI에서 요청 시작/완료와 워크플로우 완료 요약을 확인할 수 있습니다.
...
* 프론트 사용 방법은 [docs/frontend-guide.md](docs/frontend-guide.md)에서 비개발자 기준으로 정리했습니다.
