...
function useAccountData() {
  ...
  return {
    ...
    accountProductCode, setAccountProductCode,
    brokerLabel, setBrokerLabel,
    snapshot, isLoading, error, message,
    loadAccount, handleApplyConnection,
  };
}
    ...
    <main className="dashboard-page">
      <section className="page-hero">
        <div>
          ...
          <h1>계좌 연결</h1>
          <p>브로커 계좌 정보를 입력하고 저장합니다. 실제 잔고·보유 종목 조회는 계좌 상태 확인 메뉴에서 확인하세요.</p>
        </div>
      </section>
        ...
        <article className="panel panel-span-2">
          ...
          <form className="form-stack" onSubmit={handleApplyConnection}>
            ...
            <div className="field-grid field-grid-2">
              ...
              <label className="field">
                <span>상품 코드</span>
                <input value={accountProductCode} onChange={(e) => setAccountProductCode(e.target.value)} />
              </label>
            </div>
    ...
    <main className="dashboard-page">
      ...
      <section className="content-section">
        ...
        <p className="support-text">
          {snapshot?.message || "계좌 상태를 불러오면 실제 보유 비중과 손익이 여기에 나타납니다."}
        </p>
      </section>
      ...
      <section className="content-section">
        ...
        {holdings.length ? (
          <>
            ...
            <div className="table-panel" style={{ marginTop: "18px" }}>
